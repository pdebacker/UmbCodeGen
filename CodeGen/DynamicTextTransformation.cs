...
namespace UmbCodeGen.CodeGen
{
    ...
    public class DynamicTextTransformation
    {
        ...
        private DynamicTextTransformation(object instance)
        {
            ...
            _generationEnvironment = type.GetProperty(
                "GenerationEnvironment", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        public System.CodeDom.Compiler.CompilerErrorCollection Errors
        {
            get
            {
                return (System.CodeDom.Compiler.CompilerErrorCollection)_errors.GetValue(_instance, null);
            }
        }
